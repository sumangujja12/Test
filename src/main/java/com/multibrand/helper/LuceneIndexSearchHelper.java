...
public class LuceneIndexSearchHelper implements StreamLuceneConstants {
	 ...
	 * @return Analyzer
	 */
	protected static  String[] streetSuffixes = new String[] {
	...
	protected static    String[] supportedStates = new String[] {
			 "TX", "GA", "PA", "MA", "NJ", "NY", "DC"
	 };
	 
	protected static    String[] apartmentPrefixes = new String[] {
			 "APT", "UNIT", "STE"
	 };
