...
@XmlRootElement(name="FACILITYPRODUCTION")
public class SalesforceFacilityProductionResponse implements Constants  {
	
	
	@SerializedName("FacilityPeriodProductions")
	List<SalesforceFacilityPeriodProductionResponse> monthlysolardata;
	...
	@SerializedName("CurrentPeriodEndMonth")
	private String currentPeriodEndMonth;
	 ...
	 */
	public List<SalesforceFacilityPeriodProductionResponse> getMonthlysolardata() {
	 ...
	 */
	public void setMonthlysolardata(List<SalesforceFacilityPeriodProductionResponse> monthlysolardata) {
	...
	/**
	 * @return the currentPeriodEndMonth
	 */
	public String getCurrentPeriodEndMonth() {
		return currentPeriodEndMonth;
	}

	/**
	 * @param currentPeriodEndMonth the currentPeriodEndMonth to set
	 */
	public void setCurrentPeriodEndMonth(String currentPeriodEndMonth) {
		this.currentPeriodEndMonth = currentPeriodEndMonth;
	}
