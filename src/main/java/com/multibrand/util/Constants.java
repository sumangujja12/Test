...
public interface Constants {
	...
	public static final String SM_SSO_LOCKEDFLAG = "SSO_LOCKEDFLAG"; // SM prefix to indicate that it is to refer
																		// SiteMinder variable
	...
	public static final String MSG_EXCEPTION_ERROR_CODE = "MSG_EXCEPTION"; // if any exception occured either in Login
																			// Success or Login Failure Call
	public static final String MSG_LOCKED_ERROR_CODE = "MSG_LOCKED"; // customLockOut = 1 OR 2
	public static final String MSG_BAD_LOGIN_ERROR_CODE = "MSG_BAD_LOGIN"; // customLockOut = 0 AND FailureCount = 1 OR
																			// 2 OR 3
	public static final String MSG_LOCK_PENDING_ERROR_CODE = "MSG_LOCK_PENDING"; // customLockOut = 0 AND FailureCount =
																					// 4
	...
	public static final List<String> FRAUD_OR_MILITARY_CREDIT_CHECK_ZES_SEC_NOTI_HOLD_ALERT_CODE = Arrays.asList("01",
			"05", "06", "07", "03", "02", "V", "X", "W", "N", "Q", "R", "T");
	...
	// Start | US16458 | MBAR: Sprint 14 - GME Admin tool password reset issue
	// fixes. | Jenith | 2/5/2019
	public static final String PROFILE_RESPONSE_KEY = "profileResponse";
	// End | US16458 | MBAR: Sprint 14 - GME Admin tool password reset issue fixes.
	// | Jenith | 2/5/2019
