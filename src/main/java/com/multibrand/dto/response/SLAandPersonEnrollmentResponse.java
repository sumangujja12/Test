...
public class SLAandPersonEnrollmentResponse implements Serializable {
	...
	public SLAandPersonEnrollmentResponse() {
	...
	private String accountName_SLA;
	...
	public String getAccountName_SLA() {
		return accountName_SLA;
	}

	public void setAccountName_SLA(String accountName_SLA) {
		this.accountName_SLA = accountName_SLA;
	}
