...
public class ProductOfferCommonVO {
	...
	private String strThingsToKnow;
	private String isRenewable;
	private String strWebRank;
	private BigDecimal strCancelFee;
	private String strContractTerm;
	private String strTEFLDocID;
	private String strTEFLDocLink;
	private String strTEFLDocSmartCode;
	...
	private BigDecimal strIncentiveValue;
	...
	public void setStrWebRank(String strWebRank) {
		this.strWebRank = strWebRank;
	}
	...
	public BigDecimal getStrCancelFee() {
		return strCancelFee;
	}
	public void setStrCancelFee(BigDecimal strCancelFee) {
	...
	public BigDecimal getStrIncentiveValue() {
		return strIncentiveValue;
	}
	public void setStrIncentiveValue(BigDecimal strIncentiveValue) {
	...
	public BigDecimal getStrPenaltyValue() {
		return strPenaltyValue;
	}
	public void setStrPenaltyValue(BigDecimal strPenaltyValue) {
	...
	public String getStrThingsToKnow() {
		return strThingsToKnow;
	}
	public void setStrThingsToKnow(String strThingsToKnow) {
		this.strThingsToKnow = strThingsToKnow;
	}
	...
	public String getStrTEFLDocID() {
		return strTEFLDocID;
	}
	public void setStrTEFLDocID(String strTEFLDocID) {
		this.strTEFLDocID = strTEFLDocID;
	}
	public String getStrTEFLDocLink() {
		return strTEFLDocLink;
	}
	public void setStrTEFLDocLink(String strTEFLDocLink) {
		this.strTEFLDocLink = strTEFLDocLink;
	}
	public String getStrTEFLDocSmartCode() {
		return strTEFLDocSmartCode;
	}
	public void setStrTEFLDocSmartCode(String strTEFLDocSmartCode) {
		this.strTEFLDocSmartCode = strTEFLDocSmartCode;
	}
